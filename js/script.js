...
// Valid Function
// function validaton(element) {
//   let regex = {
//     userName: /^[A-Za-z 0-9]{3,15}$/,
//     userEmail: /^[A-Za-z0-9_]{3,30}\@[a-z]{3,6}\.com$/,
//     userPassword: /^[A-Za-z0-9]{5,20}$/,
//   };
...
//     console.log(error);
//     return true;
//   } else if (regex[element.id].test(element.value) == false) {
